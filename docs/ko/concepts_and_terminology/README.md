...
- [Bare Service Optimization](BARE_SERVICE_OPTIMIZATION.md) - 베어 서비스에 대한 조건부 설치, 캐싱, private_paths, 공유 서비스 연결성, assign 전략.
- [Dynamic Port Environment Variables](DYNAMIC_PORT_ENVIRONMENT_VARIABLES.md) - 자동 주입되는 `<SERVICE>_DYNAMIC_PORT` 변수와 이를 서비스 명령에서 사용하는 방법.
