...
- [Private Paths](PRIVATE_PATHS.md) - isolamento por instância para caminhos de workspace que entram em conflito em bind mounts compartilhados.
...
- [Bare Service Optimization](BARE_SERVICE_OPTIMIZATION.md) - instalações condicionais, cache, `private_paths`, conectividade com serviços compartilhados e estratégias de atribuição para serviços bare.
