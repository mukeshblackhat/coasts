...
This page collects the official Coasts tutorial videos from the Coasts YouTube channel.

If you prefer a quick video walkthrough before reading the rest of the docs, start with the overview and getting-started videos, then jump to the feature-specific topics below.

## Links

- [Coasts YouTube channel](https://www.youtube.com/@coasts-dev) - The official channel for Coasts videos.
- [Coasts playlist](https://www.youtube.com/playlist?list=PLplJaH2mu9vQFqnyJHrrls6JU0yt9CUuw) - The full tutorial playlist in one place.

## Videos

- [Coasts Overview](https://www.youtube.com/watch?v=MBGKSKau4sU&list=PLplJaH2mu9vQFqnyJHrrls6JU0yt9CUuw&index=1&pp=iAQB) (2:42) - A high-level introduction to what Coasts are and why you might use them.
- [Coasts](https://www.youtube.com/watch?v=kYlB5U9O92E&list=PLplJaH2mu9vQFqnyJHrrls6JU0yt9CUuw&index=2&pp=iAQB) (1:29) - A short tour of the core Coasts model.
...
This page reflects the current contents of the official playlist and can be updated as new tutorial videos are added.
