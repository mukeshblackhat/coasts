...
Los servicios bare se definen con secciones `[services.<name>]` en tu Coastfile. Un Coastfile puede definir servicios bare por sí solos o junto a `compose` — consulta [Mixed Service Types](MIXED_SERVICE_TYPES.md) para lo segundo.
