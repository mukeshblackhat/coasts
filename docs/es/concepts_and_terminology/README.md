...
- [Optimización de Servicios Bare](BARE_SERVICE_OPTIMIZATION.md) - instalaciones condicionales, caché, private_paths, conectividad de servicios compartidos y estrategias de asignación para servicios bare.
- [Variables de Entorno de Puerto Dinámico](DYNAMIC_PORT_ENVIRONMENT_VARIABLES.md) - las variables `<SERVICE>_DYNAMIC_PORT` inyectadas automáticamente y cómo usarlas en comandos de servicio.
