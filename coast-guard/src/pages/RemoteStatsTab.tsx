...
export default function RemoteStatsTab({ remoteName }: Props) {
  ...
  useEffect(() => {
    ...
    const url = `${protocol}//${window.location.host}/api/v1/remote/stats/stream?name=${encodeURIComponent(remoteName)}`;
